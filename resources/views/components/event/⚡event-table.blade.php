...
<div class="relative space-y-4">
    ...
    <flux:skeleton.group animate="shimmer">
        <flux:table>
            <flux:table.columns>
                <flux:table.column>Nama Event</flux:table.column>
                <flux:table.column>Tanggal & Lokasi</flux:table.column>
                <flux:table.column>Status</flux:table.column>
                <flux:table.column>Dibuat pada</flux:table.column>
                <flux:table.column class="w-50"></flux:table.column>
            </flux:table.columns>
    ...
    <flux:table wire:loading.class="opacity-50" :paginate="$this->events">
        <flux:table.columns>
        ...
        <flux:table.rows>
            ...
            <flux:table.row :key="$event->id">
                ...
                {{-- Action Menu --}}
                <flux:table.cell>
                    <fieldset class="flex items-center justify-end gap-2" wire:loading.attr="disabled">
                        {{-- Detail Event Button --}}
            ...
            <flux:table.row>
                <flux:table.cell colspan="4" class="py-12 text-center">
                    <div class="flex flex-col items-center justify-center gap-3">
                        <div
                            class="p-3 rounded-full bg-zinc-100 dark:bg-zinc-800/80 text-zinc-400 dark:text-zinc-500">
