 ...
 * @route '/livewire-3fa3e303/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-3fa3e303/upload-file',
 ...
 * @route '/livewire-3fa3e303/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-3fa3e303/preview-file/{filename}',
